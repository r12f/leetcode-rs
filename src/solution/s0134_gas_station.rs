...
//! - Discussions: <https://leetcode.com/problems/gas-station/discuss/?currentPage=1&orderBy=most_votes&query=>
//!
...
impl Solution {
    pub fn can_complete_circuit(gas: Vec<i32>, cost: Vec<i32>) -> i32 {
        ...
        for i in 0..gas.len() {
            ...
            if total_gas < min_gas {
                min_gas = total_gas;
                min_gas_index = i as i32;
            }
        }
        ...
        (min_gas_index + 1) % gas.len() as i32
    }
}
